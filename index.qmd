...
I look at cells doing cell things and ask a computer to help me make sense of it. Sometimes I write about it in [my blog](blog/).
...
(function() {
  ...
  function draw(time) {
    ...
    for (const [point, vertices] of cells) {
      ...
      // Use consistent edge color (deep teal) for all cells
      ctx.strokeStyle = `rgba(13, 115, 119, ${CONFIG.edgeOpacity * Math.max(0, edgeFade)})`;
      ctx.stroke();
    }
